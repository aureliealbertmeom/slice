...
if [ ! -f ${STDIR}/eNATL60-BLB002_y2009.1d_SST.tar ]; then
	tar -cvf eNATL60-BLB002_y2009.1d_SST.tar ${CONFIG}${SREG}-${CASE}_y${YYYY}*.${FREQ}_${VAR}.nc
	dd if=eNATL60-BLB002_y2009.1d_SST.tar of=${STDIR}/eNATL60-BLB002_y2009.1d_SST.tar bs=20M
else
